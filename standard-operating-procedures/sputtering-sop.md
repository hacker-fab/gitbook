...
6. You can use a bubble level (located in the red bin below the bench) to ensure that the wings nut support the substrate plate in a flat plane.
7.  You can simply measure the distance between the substrate plate and target by using a ruler to look at the distance between the substrate plate and the top Viton gasket. The target surface sits 5/8" above the Viton gasket.&#x20;

    <figure><img src="../.gitbook/assets/IMG_7526.jpg" alt="" width="188"><figcaption></figcaption></figure>
8.  Place your chip in the center of the substrate plate. &#x20;
...
2. Double check that both mass flow controllers are set to 0 SCCM.&#x20;
...
6. As the pump spins up to 1000Hz, ensure that the pressure is decreasing. It should reach the E-4 to E-5 range within a few minutes. It should also steadily speed up to 1000 Hz without getting stuck at any speed. If either of these happen, then something is wrong; you need to double check all your seals and consider if anything in the chamber could be outgassing. For example - alumina has very low outgassing but is porous, so if you exposed it to water, then the water will evaporate out of the alumina over an extended period of time.
7. Once the pump has reached 1000Hz smoothly, and chamber pressure is in the E-5 hPa range, it is time to wait \~24 hours for the pump to reach base pressure. This system is capable of 1.5 E-7 hPa, but may not reach it due to contamination build up in the chamber or ion-sealing surfaces. Ensure that the chamber reaches <5E-7 hPa before proceeding; otherwise, your films will not be high quality, especially films like aluminum that are very reactive with oxygen or water vapor.
...
3. On the Alicat mass flow controller, click the setpoint button, then use the select digit button, up button, and down button to set 10 SCCM. Hit the set button to actually begin flowing argon. Ensure that the MCF is flowing 10 +- .01 SCCM.
...
7.  Once the pump reaches 250Hz, it is time to make a map of flow rate and chamber pressure before striking plasma. This is necessary because when the plasma is on, the RF noise can disrupt the communication between the pressure gauge and digital control unit, giving inaccurate pressure readings. Do this by setting the MFC to various setpoints between 5 and 50 SCCM Ar. The chamber at CMU usually has the following flow-to-pressure relationship. If you're using O2, you can do this same process, but by adjusting the Ar and O2 flow rate simutlaneaously to ustain a constant O2:Ar flow ratio.
...
### Striking the plasma, impedance matching, and depositing
...
7.  If plasma does not form, you will need to adjust the TR tune knob until plasma does form.

    <figure><img src="../.gitbook/assets/IMG_7516.jpg" alt="" width="188"><figcaption></figcaption></figure>
8. If plasma still is not striking, one of the following may be the issue: the pressure may be off, the magnetron and target may not be set right, or the ground and signal may be shorted.
9.  Once the plasma is formed, use the TR tune knob to fine-tune the matching. The goal is to get the forward power > 90 watts, and the reflected power <10 watts. They do not always add up to 100.&#x20;
...
9. Put the black frame on top of the table and set the top plate on it. It may difficult to remove the top plate. If so, grip the base of the pressure gauge and Ar MFC then tilt it off.
