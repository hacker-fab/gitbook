...
<div><figure><img src="../.gitbook/assets/IMG_5115.jpg" alt=""><figcaption><p>Laptop with STM2 software and STM2 monitor plugged in</p></figcaption></figure> <figure><img src="../.gitbook/assets/IMG_5113.jpg" alt=""><figcaption><p>Double sided polyimide tape, tungsten filament, and high purity Al wire (99.999%)</p></figcaption></figure></div>
...
&#x20;![](../.gitbook/assets/IMG_7537.jpg)![](<../.gitbook/assets/IMG_7538 (1).jpg>)
...
* Turn on the pump. Monitor the pump speed in Hz. Often, around 270Hz, it makes a bad noise and stops speeding up. This can be resolved by quickly turning the pump on and off with the button on the right. It will slow to \~160Hz, then re-speed up, and pass the point at which it got stuck. This is not normal pump behavior, and we are looking into a repair.
...
* For the next step, do not touch the wires going into the chamber. If anything starts smoking, or if current is flowing but the deposition rate does not increase, you must turn off the power supply immediately.
...
* Open the lid.
* Peel the piece of tape with your chip off.
